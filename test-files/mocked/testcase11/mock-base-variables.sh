...
MAJOR_V_CONFIG_VFILE_NAME=./test-files/mocked/testcase11/app-version.cfg
...
MINOR_V_CONFIG_VFILE_NAME=./test-files/mocked/testcase11/app-version.cfg
...
PATCH_V_CONFIG_VFILE_NAME=./test-files/mocked/testcase11/app-version.cfg
...
RC_V_CONFIG_VFILE_NAME=./test-files/mocked/testcase11/app-version.cfg
...
DEV_V_CONFIG_VFILE_NAME=./test-files/mocked/testcase11/app-version.cfg
...
REPLACE_V_CONFIG_FILETOKEN_FILE=./test-files/mocked/testcase11/goquorum-node/Chart.yaml
...
REPLACE_V_CONFIG_YAMLPATH_FILE=./test-files/mocked/testcase11/goquorum-node/Chart.yaml
